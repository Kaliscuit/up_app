...
- (void)viewDidLoad
{
    ...
    _displayView  = [[UIView alloc] initWithFrame:CGRectMake(5.0f, 5.0f, 310.0f, SCREEN_HEIGHT - 69.0f)];
    [_displayView setBackgroundColor:WhiteColor];
    [self.view addSubview:_displayView];
    
    _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(15.0f, 0.0f, _displayView.frame.size.width - 15.0f, 35.0f)];
    ...
    _rankLabel = [[UILabel alloc] initWithFrame:CGRectMake(225.0f, 35.0f, 85.0f, 15.0f)];
    [_rankLabel setTextColor:BlueColor];
    [_rankLabel setTextAlignment:NSTextAlignmentRight];
    [_rankLabel setText:[NSString stringWithFormat:@"当前排名: %d", self.rankNumber]];
    ...
    CGSize size = [self.positionDescription sizeWithFont:[UIFont systemFontOfSize:14] constrainedToSize:CGSizeMake(_displayView.frame.size.width - 15.0f, MAXFLOAT) lineBreakMode:NSLineBreakByCharWrapping];
    _positionIntroduceLabel = [[UILabel alloc] initWithFrame:CGRectMake(15.0f, 95.0f, _displayView.frame.size.width - 15.0f, size.height)];
    ...
    [_positionIntroduceLabel setFont:[UIFont systemFontOfSize:14.0]];
    [_positionIntroduceLabel setNumberOfLines:0];
    ...
    if (self.positiionRequire.length == 0) {
        [positionRequireTipLabel setHidden:YES];
    }
    ...
    [_button setFrame:CGRectMake(0, _displayView.frame.size.height - 55, _displayView.frame.size.width, 50)];
