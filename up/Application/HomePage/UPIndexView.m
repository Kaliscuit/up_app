...
//    
//    UISwipeGestureRecognizer *gesture = [[UISwipeGestureRecognizer alloc] initWithTarget:self action:@selector(onSwipeInMoreSearchView:)];
//    gesture.direction = UISwipeGestureRecognizerDirectionRight;
//    [self addGestureRecognizer:gesture];
//}
//
//- (void)onSwipeInMoreSearchView:(UISwipeGestureRecognizer *)gesture {
////    UPMoreSearchResultView *moreSearchView = [UPMoreSearchResultView alloc] initWithFrame:CGRectMake(<#CGFloat x#>, <#CGFloat y#>, <#CGFloat width#>, <#CGFloat height#>)
//}
//
